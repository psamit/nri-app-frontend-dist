...
/* harmony import */ var _service_api_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./service/api.service */ "./src/app/login/service/api.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(router, fb, Toastr, apiService, jwtService) {
        this.router = router;
        this.fb = fb;
        this.Toastr = Toastr;
    ...
    onLoggedIn() {
        ...
        if (!this.loginForm.valid) {
            ...
            this.apiService.loginStaff(this.loginForm.value).subscribe(res => {
                console.log(res);
                this.disableSubmit = false;
    ...
    forgotPasswordFun() {
        ...
        if (!this.forgotPasswordForm.valid) {
            ...
            this.apiService.forgotPassword(this.forgotPasswordForm.value.email).subscribe(res => {
                this.disableSubmit1 = false;
                this.Toastr.success(res.message);
                this.resetPassword = false;
            }, () => {
...
LoginModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_4__["LoginRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
...
ApisService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
